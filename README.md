## Siti Zaharah's Software Engineering Portfolio
...
|---|---|---|
| 🛍️ [CRM Sales Opportunities](https://github.com/sitizaharahedi/Python-Projects/blob/main/CRM_Data_Cleaning_FIXED.ipynb) | Analyzed CRM data for a hardware company to identify sales pipeline bottlenecks and patterns across customers, products, and sales teams, supporting insights to improve deal conversion. | Python |     
| 🏢 [Company-Wide Project Management](https://github.com/sitizaharahedi/Company-Wide-Project-Management/tree/main) | Built a Power BI dashboard to visualize project metrics, including cost reduction, income generation, completion rates, and regional benefit vs. cost analysis. | [Power BI](https://app.powerbi.com/view?r=eyJrIjoiODIxYTM1OWItZGIyOS00OWFkLWE5YTEtYzRlMWMwMWQ2ZmM3IiwidCI6ImFjZWQ1ODNlLTRhM2ItNDJkZS05ZTQ0LTRlNWFmYTk5Yjk4YSIsImMiOjEwfQ%3D%3D) |
